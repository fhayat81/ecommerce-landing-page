...
import Image1 from "../../assets/women-shopping.png";
import Image2 from "../../assets/men-shopping.png";
import Image3 from "../../assets/banner.webp";
...
const ImageList = [
  {
    ...
    description:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident debitis accusamus ipsum, esse fuga illum.",
  },
  {
    id: 2,
    img: Image2,
...
const Hero = ({handleOrderPopup}) => {
  ...
  return (
    ...
    >
      ...
      bg-primary/40 absolute  right-0 -top-1/2
                  ...
                  className="order-1 sm:order-2">
                    <div className="relative z-10">
                      <img
                        ...
                        lg:scale-120 object-contain mx-auto overflow-hidden"
                      />
                    </div>
                  </div>
                </div>
